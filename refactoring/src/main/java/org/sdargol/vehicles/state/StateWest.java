...
public class StateWest<T extends IManager> extends State<T>{

    public StateWest(IOrientationManager orientationManager) {
        super(orientationManager, Orientation.WEST);
    }
    ...
    public void turnClockwise(IOrientationManager tractor, T manager) {
        manager.setState(new StateNorth<>(tractor));
    }
}
